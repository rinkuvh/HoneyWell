...
import { resendOtp, verifyOtp } from "../../../redux/services/UserService";
    ...
    verifyOtp(payload)
      .then((res) => {
        if (res?.status == 200) {
          ...
          navigate("/user/user-reset-password", { state: email });
          setLoading(false);
          resetForm();
        } else {
            ...
            <Index.Box className="user-auth-main w-cust">
              <Index.Box className="user-auth-inner-main user-login-inner-main">
                ...
                <Index.Typography className="user-auth-subtitle">
                  ...
                  <b>{location?.state}</b>. To continue, confirm your identity
