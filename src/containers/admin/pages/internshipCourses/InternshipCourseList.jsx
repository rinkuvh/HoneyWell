...
import {
  deleteInternshipCourseService,
  getInternshipCourses,
} from "../../../../redux/services/AdminService";

export default function InternshipCourseList() {
  ...
  const handleDeleteRecord = async () => {
    ...
    try {
      const res = await deleteInternshipCourseService(deleteState.selectedRow?.id);
  ...
  const actions = [
    {
      ...
      onClick: (row) =>
        navigate(`/admin/internship-course/view/${row?.id}`, {
    ...
    },
    {
      ...
      onClick: (row) =>
        navigate(`/admin/internship-course/edit/${row?.id}`),
    },
    {
      label: "Delete",
  ...
  const fetchData = async (
    ...
    try {
      ...
      const res = await getInternshipCourses(data);
  ...
  return (
    <>
              ...
              <Index.Box className="admin-search-box">
                <Index.Box className="admin-form-group">
                  <Index.TextField
                    ...
                    placeholder="Search Internship Course"
                    onChange={(e) => {
            ...
            <Index.Box className="admin-userlist-inner-btn-flex">
              <Index.Box className="primary-btn-main">
                <Index.Button
                  ...
                  onClick={() => navigate("/admin/internship-course/add")}
                >
      ...
      <PageIndex.ConfirmationModal
        ...
        description="Are you sure you want to delete this internship course? This action can't be undone."
      />
    </>
  );
}
