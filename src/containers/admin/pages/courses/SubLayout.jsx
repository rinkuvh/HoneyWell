...
export default function SubLayout({ courseId ,courseData,loading,isQuiz}) {
      ...
      <Index.Box className="common-tabs-outer-main course-tab">
        ...
        <TabPanel value={value} index={0} className="common-tab-panel">
          <Index.Box className="common-tabs-panel-main">
            <SectionList courseId={courseId} courseData={courseData} isDisabled={loading}/>
          </Index.Box>
        </TabPanel>
        <TabPanel value={value} index={1} className="common-tab-panel">
          <Index.Box className="common-tabs-panel-main">
            <QuizList courseId={courseId} courseData={courseData} isDisabled={loading}/>
          </Index.Box>
        </TabPanel>
